...
public class PlaneControllerSnow : MonoBehaviour
{
    ...
    public float boost_amt_x;
    public float boost_amt_y;
    public float boost_amt_z;
    ...
    private void UpdateRoll()
    {
        ...
        // Vector3 angles = child.transform.eulerAngles;
        ...
        // child.transform.eulerAngles = angles;
    }
    ...
    private void ApplyForce()
    {
        ...
        Vector3 drag = -drag_force * Mathf.Abs(Mathf.Sin(transform.eulerAngles.x)) * transform.forward;
        ...
        lift *= lift_factor * RB.velocity.magnitude / base_velocity.magnitude;
    ...
    public void Boost()
    {
        // Vector3 boost_velocity = Vector3.Scale(RB.velocity.normalized, (new Vector3(boost_amt_x, boost_amt_y, boost_amt_z)));
