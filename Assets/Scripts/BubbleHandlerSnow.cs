...
public class BubbleHandlerSnow : MonoBehaviour
{
    ...
    private void Start() {
        answeredCorrect.AddListener(GameObject.FindGameObjectWithTag("plane").GetComponent<PlaneControllerSnow>().Boost);
        answeredIncorrect.AddListener(GameObject.FindGameObjectWithTag("plane").GetComponent<PlaneControllerSnow>().Punish);
    }
